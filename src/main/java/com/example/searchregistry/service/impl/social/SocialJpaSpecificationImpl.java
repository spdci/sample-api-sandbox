...
@Service
@Slf4j
public class SocialJpaSpecificationImpl {

    public Specification<SocialPersonRecord> createSpecificationForQueryExp(Expression input) {
    ...
    public Specification<SocialPersonRecord> createSpecificationForQueryTypeforSocialPerson(String type, String value) {
