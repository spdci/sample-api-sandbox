...
import com.example.springjsonlddemo.pojo.response.*;
import com.example.springjsonlddemo.repository.PersonRecordRepository;
import com.example.springjsonlddemo.repository.PersonRepository;
import com.example.springjsonlddemo.service.ISearchService;
import com.example.springjsonlddemo.utils.JsonldToJson;
...
@Service
@Slf4j
public class SearchPersonDataImpl implements ISearchService {

    @Autowired
    JsonldToJson jsonldToJson;
    ...
    @Autowired
    private JpaSpecificationImpl specificationImpl;
        ...
        if (queryObject instanceof Map) {
            ...
            for (Map<String, Object> expressionQuery : expressionQueries) {
                if (expressionQuery.containsKey("expression1") && expressionQuery.containsKey("seq_num")) {
                    ...
                    QueryExpression queryExpression = jsonldToJson.mapToQueryExpression(expressionQuery);
